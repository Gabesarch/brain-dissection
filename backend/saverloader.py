...
def save_checkpoint(model, checkpoint_dir, step, epoch, optimizer, keep_latest=3, lr_scheduler=None, extras={}, best=False):
    if best:
...
def load_from_path(path, model, optimizer, lr_scheduler=None, strict=True, device=None):
    print("reading full checkpoint...")
